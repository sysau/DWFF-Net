...
from model import HabitatSegModel
...
def main():
    ...
    logger = TensorBoardLogger("logs", name=config['model']['arch'])
    checkpoint_callback = ModelCheckpoint(
        dirpath=str(os.path.join(config['trainer']['checkpoint_path'], config['model']['arch'])),
